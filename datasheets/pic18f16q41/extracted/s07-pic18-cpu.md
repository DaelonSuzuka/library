...
7.4.3   Multi-Word Instructions
        ...
        7-6 show more details of how three-word instructions work.
                      ...
                      Important: See the “PIC18 Instruction Execution and the Extended Instruction Set”
...
Bit 0 – PRLOCKED PR Register Lock
              ...
              0           Priority registers can be modified by write operations; Peripherals do not have access to the memory
                           ...
                           2. If the Configuration Bit PR1WAY = 1, the PRLOCKED bit cannot be cleared after it has
                              been set. A device Reset will clear the bit and allow one more set.
