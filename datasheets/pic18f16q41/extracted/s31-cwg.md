31.    CWG - Complementary Waveform Generator Module
       ...
       PWM waveforms. It is backwards compatible with previous CCP functions.
...
--- p469 ---
                    Important: Except as noted for Full Bridge mode, mode changes must only be performed
                    while EN = 0.
...
31.2.2 Push-Pull Mode
       ...
       polarity controlled by the POLC and POLD bits, respectively.
...
31.11.1 Software-Controlled Restart
        ...
        data input.
                     ...
                     Important: The SHUTDOWN bit cannot be cleared in software if the Auto-Shutdown
