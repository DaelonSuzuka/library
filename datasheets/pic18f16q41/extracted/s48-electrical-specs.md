...
48.1   Absolute Maximum Ratings(†)
       ...
       •   on VDD pin (14-pin devices)                     -40°C ≤ TA ≤ +85°C            140 mA
                                                           85°C < TA ≤ +125°C            50 mA
       •   on VDD pin (20-pin devices)                     -40°C ≤ TA ≤ +85°C            190 mA
                                                           85°C < TA ≤ +125°C            65 mA
       ...
       or any other conditions above those indicated in the operation listings of this specification is
       not implied. Exposure above maximum rating conditions for extended periods may affect device
       reliability.
...
48.2   Standard Operating Conditions
       ...
       •   Refer to the “External Clock/Oscillator Timing Requirements” table in the “AC
           Characteristics” chapter for each Oscillator mode’s supported frequencies.


--- p887 ---
48.3   DC Characteristics
48.3.1 Supply Voltage
       Table 48-1.
        ...
        3.   See the Reset, WDT, Oscillator Start-up Timer, Brown-Out Reset and Low-Power Brown-Out Reset Specifications section
             for BOR and LPBOR trip point information.
...
48.3.2 Supply Current (IDD)(1,2,4)
        Table 48-2.
         ...
         D102A            IDDHFOPLL        HFINTOSC = 64 MHz           —             4.5            5.4         mA         3.0V      All PMD
                                                                                                                                     bits are
                                                                                                                                     '1'
...
48.3.3 Power-Down Current (IPD)(1,2)
        Table 48-3.
         ...
         D200       IPD                IPD Base              —        1       3              4             μA   3.0V     ‘b11
                                                             —       0.5      4.0           9.0            μA   3.0V     ‘b10
                                                             —      38.0     53.0           68.9           μA   3.0V     ‘b01
                                                             —      171      200            245            μA   3.0V     ‘b00
         D201       IPD_WDT            Low-Frequency         —      1.41     3.50           4.50           μA   3.0V     ‘b11
                                       Internal
                                       Oscillator/WDT
         D202       IPD_SOSC           Secondary             —       2.1      4.6           7.9            μA   3.0V     ‘b11
                                       Oscillator (SOSC)
...
--- p889 ---
       ...........continued
        Standard Operating Conditions (unless otherwise stated)
         Param.        Sym.            Device           Min.    Typ.†     Max.      Max.       Units              Conditions
          No.                       Characteristics                       +85°C    +125°C               VDD     VREGPM          Note
        D203       IPD_LPBOR      Low-Power              —       1.2       3.2        4.2          μA   3.0V      ‘b11
                                  Brown-out Reset
                                  (LPBOR)
        D204       IPD_FVR_BUF1   FVR Buffer 1           —       183       215       221           μA   3.0V      ‘b11
                                  (ADC)
        D204A      IPD_FVR_BUF2   FVR Buffer 2           —       59.0     74.2       90.7          μA   3.0V     ‘bx1 or
                                  (DAC/CMP)                                                                       ‘b10
        D205       IPD_BOR        Brown-out Reset        —       16.6     20.4       20.8          μA   3.0V      ‘b11
                                  (BOR)
        D206       IPD_HLVD       High/Low Voltage       —       16.9     20.8       22.5          μA   3.0V      ‘b11
                                  Detect (HLVD)
        D207       IPD_ADCA       ADC - Active           —       485       789       790           μA   3.0V     ‘bx1 or    ADC is
                                                                                                                  ‘b10      converting
                                                                                                                            (Note 4)
        D208       IPD_CMP        Comparator             —        60       95        105           μA   3.0V      ‘b11
        D209       IPD_OPA        Operational            —      0.959     1.670     1.730       mA      3.0V      ‘b01      Charge
                                  Amplifier                                                                                 Pump On;
                                                                                                                            VICM = VDD/2
                                                         —       680       1.2        1.4          μA   3.0V      ‘b01      Charge
                                                                                                                            Pump Off;
                                                                                                                            VICM = VDD/2
        * These parameters are characterized but not tested.
        ...
        1.   The peripheral current is the sum of the base IDD and the additional current consumed when this peripheral is enabled.
             The peripheral ∆ current can be determined by subtracting the base IDD or IPD current from this limit. Max. values must
...
48.3.5 Memory Programming Specifications
       Table 48-5.
        Standard Operating Conditions (unless otherwise stated)
...
48.4.2 Internal Oscillator Parameters(1)
        Table 48-8.
         Standard Operating Conditions (unless otherwise stated)
         Param No.            Sym.         Characteristic         Min.          Typ. †    Max.         Units            Conditions
...
48.4.4 I/O and CLKOUT Timing Specifications
...
48.4.5 Reset, WDT, Oscillator Start-Up Timer, Power-Up Timer, Brown-Out Reset and Low-Power
...
48.4.7 Analog-to-Digital Converter (ADC) Accuracy Specifications(1,2)
        Table 48-13.
         ...
         AD02          EIL      Integral Non-Linearity Error                               —      ±0.1      ±2.0     LSb     ADCREF+ = 3.0V,
                                                                                                                             ADCREF- = 0V

         AD03          EDL      Differential Non-Linearity Error                           —      ±0.1      ±1.0     LSb     ADCREF+ = 3.0V,
                                                                                                                             ADCREF- = 0V
...
48.4.10 8-Bit DAC Specifications
        Table 48-15.
         Standard Operating Conditions (unless otherwise stated)VDD = 3.0V, TA = 25°C
          Param No.         Sym.             Characteristic            Min.              Typ. †              Max.      Units             Conditions
         DSB01             VLSB        Step Size                        —              (VDACREF+ -             —            V
                                                                                      VDACREF-)/256
         DSB02             VACC        Absolute Accuracy               -2.5               1.9                  7.0      LSb
...
--- p902 ---
        ...........continued
         Standard Operating Conditions (unless otherwise stated)VDD = 3.0V, TA = 25°C
          Param No.          Sym.            Characteristic        Min.              Typ. †             Max.     Units           Conditions
         DSB05*         VDBO         DAC Buffer Offset(2)           —                 20                 45       mV
         DSB06*         INL          Intergral Nonlinerarity       -1.7                1                1.9       LSb    0x09 ≤ DAC.DATA <
                                                                                                                         0x246
         DSB07*         DNL          Differential Nonlinearity     -0.5               0.4               1.2       LSb    0x09 ≤ DAC.DATA <
                                                                                                                         0x246
         DSB08*         EOFF         Offset Error                  -0.8               1.4               2.5       LSb    0x09 ≤ DAC.DATA <
                                                                                                                         0x246
         DSB09*         EGN          Gain Error                    -1.7               -1.2              0.8       LSb    0x09 ≤ DAC.DATA <
                                                                                                                         0x246
         * These parameters are characterized but not tested.
         † Data in “Typ” column is at 3.0V, 25°C unless otherwise stated. These parameters are for design guidance only and are not
         tested.
...
48.4.11 Operational Amplifier Specifications
        Table 48-16.
         Standard Operating Conditions (unless otherwise stated)VDD = 3.0V, TA = 25°C
         Param No.      Sym.                 Characteristic               Min.       Typ. †      Max.           Units            Conditions
         OPA01*        GBWP Gain Bandwidth Product                         —           —          5.5           MHz
         OPA02         TON          Turn-on Time                           —          0.9         —              μs
         OPA03*        PM           Phase Margin                           —          80          —            degrees
         OPA04*        SR           Slew Rate                              —           8          —             V/μs
         OPA05         OFF          Offset                                 —          ±2          —              mV
         OPA06         CMRR         Common-Mode Rejection                 45          60          —              dB      0.9VDD-0.1VDD
                                    Ratio
         OPA07*        AOL          Open-Loop Gain                         —          80          —              dB      Open-Loop Gain (Phase)
         OPA08*        VICM         Input Common-Mode Voltage             VSS          —          VDD             V      Charge Pump On; VDD >
                                                                                                                         2.5V
                                                                           —           —          —                      Charge Pump Off; VDD >
                                                                                                                         2.5V
         OPA09*        Eni          Input Noise Voltage                    —          160         —              μV
         OPA10*        eni          Input Noise Voltage Density            —          70          —            nV/√(Hz) 10 kHz
         OPA11*        PSRR         Power Supply Rejection Ratio           —          67          —              dB
         OPA12*        ISC          Short Circuit Current                  —          10          —              mA
         OPA13         VOS          Voltage Output Swing            (0.15) * VDD       —      (0.85) * VDD        V
         OPA14         IO           Maximum Output Current                 —          0.5         —              nA
         * These parameters are characterized but not tested.
         † Data in “Typ” column is at 3.0V, 25°C unless otherwise stated. These parameters are for design guidance only and are not
         tested.
...
48.4.20 Temperature Indicator Requirements
        ...
        TS02*          MV          Voltage Sensitivity         High Range          —      -3.75         —        mV/°C        TSRNG = 1
