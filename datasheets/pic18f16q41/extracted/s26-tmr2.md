26.   TMR2 - Timer2 Module
      ...
      See figure below for a block diagram of Timer2.
                        ...
                        Important: References to module Timer2 apply to all the even numbered timers on this
                        device (Timer2, Timer4, etc.).
...
26.1.1 Free-Running Period Mode
       ...
       bits of the T2CON register then a one clock period wide pulse occurs on the TMR2_postscaled
...
26.8     Operation Examples
         ...
         •   The PWM Duty Cycle and PWM output are illustrated assuming that the timer is used for the
             PWM function of the CCP module as described in the “PWM Overview” section. The signals are
             not a part of the Timer2 module.
