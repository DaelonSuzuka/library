...
14.6   RESET Instruction
       A RESET instruction will cause a device Reset. The RI bit will be set to ‘0’. See 14.11. Determining the
       Cause of a Reset for default conditions after a RESET instruction has occurred.
...
14.12 Power Control (PCON0/PCON1) Registers
      ...
      Hardware will change the corresponding register bit or bits as a result of the Reset event. Bits
      for other Reset events remain unchanged. See 14.11. Determining the Cause of a Reset for more
      details.
