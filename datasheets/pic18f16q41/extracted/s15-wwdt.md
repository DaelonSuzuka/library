...
15.1   Independent Clock Source
       ...
       WDTE = ‘b01, the SEN bit will be set by software to enable WWDT, and the clock source is enabled
       by the CS bits. Time intervals in this chapter are based on a minimum nominal interval of 1 ms. See
       the device Electrical Specifications for LFINTOSC and MFINTOSC tolerances.
