...
43.1   Comparator Overview
       A single comparator is shown in Figure 43-1 along with the relationship between the analog input
...
--- p777 ---
       ...
       must be clear to enable the pin as an output.
                    ...
                    Important: The internal output of the comparator is latched with each instruction cycle.
...
43.2.3 Comparator Output Polarity
       ...
       POL bit results in a noninverted output. Table 43-1 shows the Output state versus Input conditions,
...
43.3   Comparator Output Synchronization
       ...
       the comparator module is shown in Figure 43-2. Refer to the “TMR1 - Timer1 Module with Gate
...
--- p778 ---
                   Important: Although a comparator is disabled, an interrupt will be generated by changing
                   the output polarity with the POL bit.
...
43.7   Comparator Negative Input Selection
       ...
       input of the comparator.
                   ...
                   Important: To use CxINy+ and CxINy- pins as analog input, the appropriate bits must be
                   set in the ANSEL register and the corresponding TRIS bits must also be set to disable the
                   output drivers.
...
43.9   Analog Input Connection Considerations
       A simplified circuit for an analog input is shown in Figure 43-3. Since the analog input pins share
