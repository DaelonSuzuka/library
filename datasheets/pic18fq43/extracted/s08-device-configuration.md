...
8.1   Configuration Settings
      ...
      Resets and memory protection options. These are implemented at 0x300000 - 0x300009.
                  ...
                  operation, this bit needs to be maintained as a ‘1’.
...
8.3   User ID
      ...
      writable during normal execution. See the “User ID, Device ID, Configuration Settings Access,
      ...
      “PIC18FXXQ43 Family Programming Specification” (DS40002079D).
...
Bits 2:0 – WDTCWS[2:0] WDT Window Select(1)
                                                       WDTCON1[WINDOW] at POR
                                                                                                             Software Control of
                    WDTCWS                       Window Delay Percent of       Window Opening Percent
                                     Value                                                                        WINDOW
                                                         Time                         of Time
                      111               111                 n/a                          100                         Yes
                      110               110                 n/a                          100
                      ...
                      000               000                 87.5                         12.5
              Note:
              1.    For any setting other than WDTCWS = 111, user firmware has to arm the WDT by reading the WDTCON0 register before
                    executing the CLRWDT instruction.
...
Bits 2:0 – BBSIZE[2:0] Boot Block Size Selection(2)
              ...
              Table 8-1. Boot Block Size
                      ...
                      BBEN                  BBSIZE
                                                                Boot Block        PIC18Fx5Q43              PIC18Fx6Q43            PIC18Fx7Q43
                          1                     xxx                 –                                           –
                          0                     111             00 03FFh                                       512
                          0                     110             00 07FFh                                      1024
                          0                     101             00 0FFFh                                      2048
