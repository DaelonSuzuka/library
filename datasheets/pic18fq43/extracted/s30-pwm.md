                                                                                                    PIC18F27/47/57Q43
                                                                                       PWM - Pulse-Width Modulator with
                                                                                                              Compare
...
30.5   Buffered Period and Parameter Registers
       ...
       of multiple PWM instances simultaneously with the PWMLOAD register.
                      ...
                      Important: No changes are allowed after the LD bit is set until after the LD bit
                      is cleared by hardware. Unexpected behavior may result if the LD bit is cleared by
                      software.
...
Bits 4:0 – ERS[4:0] External Reset Source Select
                ...
                11111-10010                                        Reserved (ERS Disabled)
                   ...
                   01011                                                 CLC2_OUT
                   01010                                                 CLC1_OUT
                   01001                                           Reserved (ERS Disabled)
                   01000                                           Reserved (ERS Disabled)
                   ...
                   00010                  Reserved                    PWM1S1P1_OUT                   PWM1S1P1_OUT
...
Bit 7 – EN PWM Module Enable
            ...
            0          PWM module is disabled. The prescaler, postscaler, and all internal logic are reset. Outputs go to their default
