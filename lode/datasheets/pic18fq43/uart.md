# PIC18F27/47/57Q43 UART Peripheral

## Instances & Register Map
Q43 has 2 UART instances. UART1 is full-featured (LIN/DMX/DALI/checksum/collision). UART2 is limited (no UxRXCHK, UxTXCHK, C0EN, UxP1H/UxP2H/UxP3H, TXCIF).
...
## Baud Rate Generator
**Formulas:**
- BRGS=0 (normal): `BaudRate = FOSC / [16 x (UxBRG + 1)]`
- BRGS=1 (high-speed): `BaudRate = FOSC / [4 x (UxBRG + 1)]`

**Solving for UxBRG:**
- BRGS=0: `UxBRG = (FOSC / (16 x DesiredBaud)) - 1`
- BRGS=1: `UxBRG = (FOSC / (4 x DesiredBaud)) - 1`
