# PIC18F27/47/57Q43 — Signal Measurement Timer (SMT1)
...
- Q43 SMT1 SSEL mux substitutes CCP3 for CCP2+3 positions and drops CCP4, PWM5–8 entries, replacing them with CCP2–3 and CLC3–8.
- K42 SSEL entries for CCP2–4 and PWM5–8 are replaced in Q43 with CCP2–3 and no direct PWM entries (PWM uses slice outputs routed through CLC or other muxes).
- WSEL mux similar reorganization: Q43 omits CCP4, PWM5–8, CLC3–4 entries and adds CLC5–8.
- Register layout and mode encodings are identical between K42 and Q43.